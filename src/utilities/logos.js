...
const ExitSVG = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
...
const LogoutSVG = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
...
const SettingsSVG = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
...
const SearchSVG = ({ color, height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 50 50"
...
const EmptyHeartSVG = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
...
const FullHeartSVG = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
...
const CopySvg = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      height={height}
